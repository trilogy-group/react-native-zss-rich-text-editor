...
const ListHeaderComponent = search => {
	return <Text style={styles.headerTextStyle}>Search: {search}</Text>;
};
...
const MentionList = props => {
	...
	const renderItem = ({ item, index }) => {
		...
		return (
			<TouchableOpacity
				...
				onPress={_onItemPress.bind(this, item, index)}
			>
	...
	const _onItemPress = (item, index) => {
		...
		const items = getFilteredData(search);
	...
	return (
		<FlatList
			data={getFilteredData(search)}
			contentContainerStyle={styles.contentContainerStyle}
			renderItem={renderItem}
			ListHeaderComponent={ListHeaderComponent.bind(null, search)}
